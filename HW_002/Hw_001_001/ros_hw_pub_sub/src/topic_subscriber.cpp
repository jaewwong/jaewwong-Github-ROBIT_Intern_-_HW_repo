...
void msgCallback(const ros_hw_pub_sub::hw::ConstPtr& msg)
{
    std::string str;
ROS_INFO("stamp.sec = %d", msg->stamp.sec);
// stamp.sec 메시지를 표시한다
ROS_INFO("stamp.nec = %d", msg->stamp.nsec);
// stamp.nsec 메시지를 표시한다


str = msg->message;
std::cout<<"data1 = "<<msg->data1<<std::endl;
std::cout<<"data2 = "<<msg->data2<<std::endl;

std::cout<<"message = "<<str<<std::endl;
nh.getParam("data1",num);
nh.getParam("data2",num2);
nh.getParam("message",str);
}
